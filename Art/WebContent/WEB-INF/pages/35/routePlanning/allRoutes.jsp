...
//     接著我們把圖層控制的功能（L.control.layers）加入地圖中：   
	L.control.layers(baseLayers, overlays, {collapsed: false}).addTo(leafletMap);
...
//				設定地圖中心
            	leafletMap.setView([userLat, userLon], 15 - Math.round(userDistance/10));
// 				繪製查詢中心點圖釘
