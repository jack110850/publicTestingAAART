...
public class CourseEmailService {
	...
	public void mailtoCo(CourseOrders cos) throws MessagingException {
		...
		String subject = "訂單編號"+cos.getOrderNoCo()+"購物詳細";
		String text = 
				"\r\n" + 
				...
				"                     </tr> \r\n" + 
				"                     <tr style=\"border-collapse:collapse\"> \r\n" + 
				"                      <td align=\"center\" style=\"padding:0;Margin:0;padding-top:10px;padding-bottom:10px\"><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:15px;font-family:tahoma, verdana, segoe, sans-serif;line-height:23px;color:#333333\">訂單編號："+cos.getOrderNoCo()+"<br>訂購人ID："+cos.getmemberId()+"<br>電子郵件："+cos.getEmail()+"<br>地址："+cos.getCustomerAddress()+"<br>總金額："+cos.getTotalAmount()+"</p></td> \r\n" + 
				"                     </tr> \r\n" +
				"                     <tr style=\"border-collapse:collapse\"> \r\n" + 
